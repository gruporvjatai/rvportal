    ...
    return `
      <div class="space-y-6">
        ...
        <div class="flex items-center gap-3 bg-white p-3 rounded-xl border shadow-sm">
          ...
          <button onclick="refresh()" class="bg-slate-200 hover:bg-slate-300 text-slate-700 px-3 py-2 rounded-lg text-sm font-bold" title="Atualizar Lista"><i data-lucide="list-restart" class="w-4 h-4"></i></button>          
        </div>
